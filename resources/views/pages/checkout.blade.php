...
<div id="page-content">
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12 d-flex justify-content-between align-items-center">
                    <div class="page-title">
                        <h1>One Page Checkout Style1</h1>
                    </div>
                    <!--Breadcrumbs-->
    ...
    <div class="container">
        <!--Checkout Content-->
        <form class="checkout-form" method="post" action="{{ route('order.place') }}">
            <div class="row">
                            ...
                            <fieldset>
                                <div class="row">
                                    <div class="form-group col-12 col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <input name="firstname" value="" id="firstname" type="text" required="" class="form-control">
                                    </div>
                                    <div class="form-group col-12 col-sm-6 col-md-6 col-lg-6">
                                        <label for="lastname" class="form-label">Last Name <span class="required">*</span></label>
                                        <input name="lastname" value="" id="lastname" type="text" required="" class="form-control">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-12 col-sm-12 col-md-12 col-lg-12">
                                        <label for="address-1" class="form-label">Address <span class="required">*</span></label>
                                        <input name="address_1" value="" id="address-1" type="text" required="" placeholder="Street address" class="form-control">
                                    </div>
                                    <div class="form-group col-12 col-sm-12 col-md-12 col-lg-12">
                                        <input name="address_2" value="" id="address-2" type="text" required="" placeholder="Apartment, suite, unit etc. (optional)" class="form-control">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-12 col-sm-6 col-md-6 col-lg-6">
                                        <label for="postcode" class="form-label">Postcode / ZIP <span class="required">*</span></label>
                                        <input name="postcode" value="" id="postcode" type="text" class="form-control">
                                    </div>
                                    <div class="form-group col-12 col-sm-6 col-md-6 col-lg-6">
                                        <label for="address_country1" class="form-label">Country <span class="required">*</span></label>
                                        <select id="address_country1" name="address[country]" data-default="United States" class="form-control">
                                ...
                                <div class="row">
                                    <div class="form-group col-12 col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <select id="address_State" name="address[State]" data-default="" class="form-control">
                                    ...
                                    <div class="form-group col-12 col-sm-6 col-md-6 col-lg-6">
                                        ...
                                        <select id="address_province" name="address[province]" data-default="" class="form-control">
                                            <option value="0" label="Select a city" selected="selected">Select a city</option>
                                            <option value="AR">Arkansas</option>
                                            <option value="CA">California</option>
                                            <option value="DE">Delaware</option>
                                            <option value="FL">Florida</option>
                ...
                <div class="col-lg-4 col-md-5 col-sm-12 col-12">
                    ...
                    <div class="cart-info">
                        <div class="cart-order-detail cart-col">
                            ...
                            @csrf
                            <button type="submit" class="btn btn-lg my-4 checkout w-100">Place order</button>
