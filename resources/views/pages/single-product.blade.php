                                ...
                                <div class="product-item swatches-size w-100 mb-4 swatch-1 option2" data-option-index="1">
                                    ...
                                    <ul class="variants-size size-swatches d-flex-center pt-1 clearfix">
                                        @foreach($product->sizes as $size)
                                            <li class="swatch x-large @if($size['quantity'] > 1) soldout @endif"><span class="swatchLbl" data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $size['size'] }}">{{ $size['size'] }}</span></li>
                                        @endforeach
                                    </ul>
                                </div>                                
                                <!-- End Swatches Size -->
