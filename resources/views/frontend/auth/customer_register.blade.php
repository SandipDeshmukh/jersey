                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
                            <div class="inner h-100">
                                <form method="post" action="{{ route('customer.register') }}" class="customer-form">
                                    @csrf
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <input type="text" name="name" placeholder="Username" id="CustomerUsername" value="" required />
                                        </div>
                                        <div class="form-group col-12">
                                        ...
                                        <div class="form-group col-12">
                                            <label for="CustomerEmail" class="d-none">Mobile Number <span class="required">*</span></label>
                                            <input type="text" name="phone" placeholder="Mobile number" id="mobileNumber" value="" required />
                                        </div>
                                        <div class="form-group col-12">
                                    ...
                                    <div class="login-signup-text mt-4 mb-2 fs-6 text-center text-muted">Already have an account? <a href="{{route('customer.login')}}" class="btn-link">Login now</a></div>
                                </form>
                            </div>
                        </div>
                    </div>
