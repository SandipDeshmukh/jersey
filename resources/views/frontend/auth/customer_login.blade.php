                        ...
                        <div class="col-12 col-sm-12 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
                            <div class="inner h-100">
                                <form method="post" action="{{ route('customer.login') }}" class="customer-form">
                                    ...
                                    <div class="login-signup-text mt-4 mb-2 fs-6 text-center text-muted">Don,t have an account? <a href="{{route('customer.register')}}" class="btn-link">Sign up now</a></div>
                                </form>
