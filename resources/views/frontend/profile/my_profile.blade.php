                            ...
                            <ul class="default-option">
                                <li>
                                    <div class="option english">
                                        <div class="icon"><img src="/assets/images/flag/english.png" alt="english" width="24" height="24" /></div><span>English</span>
                                    </div>
                                </li>
                            </ul>
                            <ul class="select-ul">
                                ...
                                <li>
                                    <div class="option arabic">
                                        <div class="icon"><img src="/assets/images/flag/arabic.png" alt="arabic" width="24" height="24" /></div><span>Arabic</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="option english">
                                        <div class="icon"><img src="/assets/images/flag/french.png" alt="french" width="24" height="24" /></div><span>French</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="default-option">
                                <li>
                                    <div class="option USD">
                                        <div class="icon"><img src="/assets/images/flag/usd.png" alt="usd" width="24" height="24" /></div><span>USD</span>
                                    </div>
                                </li>
                            </ul>
                            <ul class="select-ul">
                                ...
                                <li>
                                    <div class="option EUR">
                                        <div class="icon"><img src="/assets/images/flag/eur.png" alt="eur" width="24" height="24" /></div><span>EUR</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="option GBP">
                                        <div class="icon"><img src="/assets/images/flag/gbp.png" alt="gbp" width="24" height="24" /></div><span>GBP</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                                                    ...
                                                    <div class="item">
                                                        <div class="product-wrap position-relative">
                                                            ...
                                                            <div class="product-image mb-0">
                                                                <a href="product-layout1.html" class="product-img"><img class="rounded-0 blur-up lazyload" data-src="/assets/images/megamenu/product1.jpg" src="/assets/images/megamenu/product1.jpg" alt="product" title="Product" width="625" height="808" /></a>
                                                ...
                                                <ul class="items g-2 g-md-3 row row-cols-lg-4 row-cols-md-3 row-cols-sm-2">
                                                    ...
                                                    <li class="item">
                                                        <div class="mini-list-item d-flex align-items-center w-100 clearfix">
                                                            <div class="mini-image text-center"><a class="item-link" href="product-layout1.html"><img class="rounded-0 blur-up lazyload" data-src="/assets/images/products/120x170.jpg" src="/assets/images/products/120x170.jpg" alt="image" title="product" width="120" height="170" /></a></div>
                        ...
                        <div class="dashboard-sidebar bg-block">
                            <div class="profile-top text-center mb-4 px-3">
                                <div class="profile-image mb-3">
                                    <img class="rounded-circle blur-up lazyload" data-src="/assets/images/users/user-img1.jpg" src="/assets/images/users/user-img1.jpg" alt="user" width="130" />
                                </div>
                                <div class="profile-detail">
                                    <h3 class="mb-1">Jecno Janesen</h3>
                                    ...
                                    <div class="row g-3 row-cols-lg-3 row-cols-md-3 row-cols-sm-3 row-cols-1 mb-4">
                                        <div class="counter-box">
                                            <div class="bg-block d-flex-center flex-nowrap">
                                                <img class="blur-up lazyload" data-src="/assets/images/icons/64x64.png" src="/assets/images/icons/64x64.png" alt="icon" width="64" height="64" />
                                                <div class="content">
                                        ...
                                        <div class="row row-cols-lg-2 row-cols-md-2 row-cols-sm-1 row-cols-1">
                                            <div class="box-info mb-4">
                                                ...
                                                <div class="box-content mt-3">
                                                    ...
                                                    <p><a href="#" class="btn-link">Change Password</a></p>
                                                </div>
                                            </div>
                                            <div class="box-info mb-4">
                                                <div class="box-title d-flex-center">
                                        ...
                                        <div class="modal fade" id="addNewModal" tabindex="-1" aria-labelledby="addNewModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form class="add-address-from" method="post" action="{{route('customer.profile.add.address')}}">
                                                        <div class="modal-body">
                                                                ...
                                                                <div class="form-row row-cols-lg-2 row-cols-md-2 row-cols-sm-1 row-cols-1">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="new-street-address" class="d-none">Address <span class="required">*</span></label>
                                                                        <input name="address" placeholder="Street Address" value="" id="new-street-address" type="text" />
                                                                    </div>
                                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input name="mobile" placeholder="Telephone" value="" id="new-telephone" type="tel">
                                                                    </div>
                                                                    <div class="form-group mb-md-0">
                                                                        <label for="new-zone" class="d-none">Region / State <span class="required">*</span></label>
                                                                        <select name="state" id="new-zone">
                                                                    ...
                                                                    <div class="form-group mb-0">
                                                                        ...
                                                                        <select name="country" id="new-country">
                                                                            <option value="">Select Country</option>
                                                                            <option value="1" label="Anguilla">Anguilla</option>
                                                                            <option value="2" label="Antigua and Barbuda">Antigua and Barbuda</option>

                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <input type ="hidden" name="customer_id" value="{{$data['custId']}}">
                                                        </div>
                                                ...
                                                <div class="address-box bg-block">
                                                    ...
                                                    <div class="middle">
                                                        <div class="address mb-2 text-muted">
                                                            <address class="m-0">{{$ad->address}}, <br />State name and {{$ad->postCode}}.</address>
                                                        </div>
                                                        <div class="number">
                                                            <p>Mobile: <a href="tel:401234567890">{{$ad->mobile}}</a></p>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="address-select-box active">
                                                <div class="address-box bg-block">
                                                    <div class="top bank-logo d-flex-justify-center justify-content-between mb-3">
                                                        <img src="/assets/images/icons/bank-logo1.png" class="bank-logo" width="60" alt="" />
                                                        <img src="/assets/images/icons/bank-logo1.png" class="network-logo" width="60" alt="" />
                                                    </div>
                                                    <div class="middle">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-12 mb-4">
                                                                <div class="profileImg img-thumbnail shadow bg-white rounded-circle d-flex-justify-center position-relative mx-auto">
                                                                    <img src="/assets/images/users/user-img1.jpg" class="rounded-circle" alt="profile" width="200" height="200" />
